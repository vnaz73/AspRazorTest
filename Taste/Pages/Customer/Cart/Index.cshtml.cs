...
namespace Taste.Pages.Customer.Cart
{
    public class IndexModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            if (claim != null)
            {
                IEnumerable<ShoppingCart> cart = unitOfWork.ShoppingCart.GetAll(c => c.ApplicationUserId == claim.Value);
                ...
                {
                    cartList.MenuItem = unitOfWork.MenuItem.GetFirstOrDefault(m => m.Id == cartList.MenuItemId);
        ...
        public IActionResult OnPostMinus(int cartId)
        {
            ...
            if (cart.Count == 1)
            {
                ...
                var cnt = unitOfWork.ShoppingCart.
